...
class ScaleTextWidget extends StatefulWidget {
  final String? text;
  final TextStyle? textStyle;

  const ScaleTextWidget({Key? key, required this.text, this.textStyle})
      : assert(text != null),
        super(key: key);
...
class _DiffScaleTextState extends State<ScaleTextWidget> with TickerProviderStateMixin<ScaleTextWidget> {
  ...
  @override
  void didUpdateWidget(ScaleTextWidget oldWidget) {
  ...
  Widget build(BuildContext context) {
    TextStyle? textStyle = widget.textStyle == null ? TextStyle(fontSize: 20, color: Colors.white) : widget.textStyle;
...
class _DiffText extends CustomPainter {
  ...
  _DiffText({required this.text, required this.textStyle, this.progress = 1, this.alignment = Alignment.center})
      : assert(text != null),
      ...
      for (_TextLayoutInfo _oldTextLayoutInfo in _oldTextLayoutInfo) {
        if (_oldTextLayoutInfo.needMove) {
          ...
          drawText(
              ...
              1,
              Offset(
                _oldTextLayoutInfo.offsetX! - (_oldTextLayoutInfo.offsetX! - _oldTextLayoutInfo.toX!) * p,
